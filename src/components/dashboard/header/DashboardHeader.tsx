  ...
  return (
    <header className="mb-8 flex justify-between items-center relative z-10">
      <div className="glass-card p-6 rounded-lg w-full max-w-2xl">
        <h2 className="text-4xl font-bold text-white animate-pulse-slow" tabIndex={0}>
          System Dashboard
        </h2>
        <p className="text-white/90" tabIndex={0}>
      ...
      <div className="flex items-center gap-4">
        ...
        <RouterLink 
          to="/settings" 
          className="flex items-center gap-2 px-6 py-3 rounded-md hover:bg-green-900/20 transition-all duration-300 glass-card text-white"
        >
