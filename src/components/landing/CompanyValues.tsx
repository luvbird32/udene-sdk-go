...
const CompanyValues = () => {
  return (
    <section className="py-24 bg-secondary-dark/40">
      <div className="container mx-auto px-4 space-y-32">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-primary-light text-center mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-lg text-primary-light">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-primary-light text-center mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-secondary-dark/40 p-6 rounded-lg border border-primary/20 hover:border-primary/30 transition-colors">
              <h3 className="text-xl font-semibold text-primary mb-4">Protect</h3>
              <p className="text-primary-light">Safeguard businesses from financial losses and reputation damage through advanced threat detection and prevention.</p>
            </div>
            <div className="bg-secondary-dark/40 p-6 rounded-lg border border-primary/20 hover:border-primary/30 transition-colors">
              <h3 className="text-xl font-semibold text-primary mb-4">Innovate</h3>
              <p className="text-primary-light">Continuously evolve our technology to stay ahead of emerging threats and provide cutting-edge protection.</p>
            </div>
            <div className="bg-secondary-dark/40 p-6 rounded-lg border border-primary/20 hover:border-primary/30 transition-colors">
              <h3 className="text-xl font-semibold text-primary mb-4">Empower</h3>
              <p className="text-primary-light">Enable businesses to grow confidently by providing them with the tools and insights they need to thrive securely.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-secondary-dark/40 p-8 rounded-lg border border-primary/20 hover:border-primary/30 transition-colors">
              <h3 className="text-2xl font-semibold text-primary mb-4">Universal Protection</h3>
              <p className="text-primary-light mb-4">Develop and maintain comprehensive security solutions that protect against all forms of digital exploitation, from basic fraud attempts to sophisticated system manipulation.</p>
              <ul className="list-disc list-inside text-primary-light space-y-2">
            ...
            <div className="bg-secondary-dark/40 p-8 rounded-lg border border-primary/20 hover:border-primary/30 transition-colors">
              ...
              <p className="text-primary-light mb-4">Stay at the forefront of security technology through continuous research and development of new protection mechanisms.</p>
              <ul className="list-disc list-inside text-primary-light space-y-2">
            ...
            <div className="bg-secondary-dark/40 p-8 rounded-lg border border-primary/20 hover:border-primary/30 transition-colors">
              ...
              <p className="text-primary-light mb-4">Ensure our clients achieve maximum protection while maintaining operational efficiency and user experience.</p>
              <ul className="list-disc list-inside text-primary-light space-y-2">
