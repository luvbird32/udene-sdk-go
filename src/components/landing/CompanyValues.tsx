      ...
      <div className="container mx-auto px-4 space-y-32">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 justify-center mb-6">
            ...
            <h2 className="text-4xl font-bold text-center text-white">Why We Exist</h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 justify-center mb-6">
            <Target className="w-8 h-8 text-primary animate-pulse-slow" />
            <h2 className="text-4xl font-bold text-center text-white">Our Mission</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-black/40 p-6 rounded-lg border border-primary/20 hover:border-primary/40 transition-colors">
              <h3 className="text-xl font-semibold text-white mb-4">Protect</h3>
              <p className="text-white/80">Safeguard businesses from financial losses and reputation damage through advanced threat detection and prevention.</p>
            </div>
            <div className="bg-black/40 p-6 rounded-lg border border-primary/20 hover:border-primary/40 transition-colors">
              <h3 className="text-xl font-semibold text-white mb-4">Innovate</h3>
              <p className="text-white/80">Continuously evolve our technology to stay ahead of emerging threats and provide cutting-edge protection.</p>
            </div>
            <div className="bg-black/40 p-6 rounded-lg border border-primary/20 hover:border-primary/40 transition-colors">
              <h3 className="text-xl font-semibold text-white mb-4">Empower</h3>
              <p className="text-white/80">Enable businesses to grow confidently by providing them with the tools and insights they need to thrive securely.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 justify-center mb-6">
            ...
            <h2 className="text-4xl font-bold text-center text-white">Our Objectives</h2>
          </div>
          <p className="text-xl text-white/90 text-center mb-12">
            We're committed to creating a safer digital ecosystem where businesses can operate with confidence and security.
          </p>
          <div className="space-y-6">
            <div className="bg-black/40 p-8 rounded-lg border border-primary/20 hover:border-primary/40 transition-colors">
              <h3 className="text-2xl font-semibold text-white mb-4">Universal Protection</h3>
              <p className="text-white/80 mb-4">Develop and maintain comprehensive security solutions that protect against all forms of digital exploitation, from basic fraud attempts to sophisticated system manipulation.</p>
            ...
            <div className="bg-black/40 p-8 rounded-lg border border-primary/20 hover:border-primary/40 transition-colors">
              ...
              <p className="text-white/80 mb-4">Stay at the forefront of security technology through continuous research and development of new protection mechanisms.</p>
              <ul className="list-disc list-inside text-white/80 space-y-2">
            ...
            <div className="bg-black/40 p-8 rounded-lg border border-primary/20 hover:border-primary/40 transition-colors">
              ...
              <p className="text-white/80 mb-4">Ensure our clients achieve maximum protection while maintaining operational efficiency and user experience.</p>
              <ul className="list-disc list-inside text-white/80 space-y-2">
