...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => {
  return (
    <Card className="group relative overflow-hidden p-6 bg-black/40 border border-primary/10 hover:border-primary/40 transition-all duration-300 hover:scale-[1.02]">
